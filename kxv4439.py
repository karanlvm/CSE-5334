...
# Precomputing doc vectors for query function
...
def query(qstring):
    ...
    # To calculate unit vector of the query
    ...
    # To calculate cosine similarity between the query vector and each document vector
    scores = {}
    ...
    # Selecting the document with the highest cosine similarity
